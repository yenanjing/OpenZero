...
# Paths
DATA_DIR=/apdcephfs_cq11_2973545/share_2973545/wenweiwwli/projects/OpenZero/data/open_industry/v5
MODEL_PATH=/apdcephfs_cq11_2973545/share_2973545/wenweiwwli/models/QwQ_32B/QwQ-32B
CKPTS_DIR=${CKPTS_DIR:-"/apdcephfs/share_7435717/wenweiwwli/models/ckpts/${project_name}/${exp_name}"}
